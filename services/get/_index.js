...
var index = {
	...
	render: function(req, res) {
		...
		var examples = [
			...
			'/v2/portals/personal_juegos_android/lists/2/games?page=1&size=3',
			'/v2/portals/personal_juegos_android/lists/2;5;6/games?page=1&size=3',
			'/v2/portals/personal_juegos_android/games/3',
			'/v2/portals/personal_juegos_android/games/3/related/games?size=2',
			'/v2/portals/personal_juegos_android/games/my-games?token=2&page=1&size=3',
