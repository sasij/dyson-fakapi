...
var index = {
	...
	render: function(req, res) {
		...
		var examples = [
			...
			'/v2/portals/personal_juegos_android/games-android/3/related/games?size=2',
			'/v2/portals/personal_juegos_android/games-android/my-games?token=2&page=1&size=3',
